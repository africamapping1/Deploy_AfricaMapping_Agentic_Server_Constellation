# RealEstate AI Business Model

## Purpose

This directory contains the tenant-specific business model for `realestate-ai`.
...
A business should not be represented only through property records, project entries, and dashboards.

The system needs a structured view of:

- who the business serves
- what value it provides
- how it reaches customers and users
- how relationships are maintained
- how value is captured economically
- what resources and activities are essential
- what partnerships matter
- what cost structure supports the business

This directory exists to hold that structural truth for `realestate-ai`.

## Relationship to the Framework

`server-10-applications/business-framework/business-model/` provides the reusable model structure.

`apps/realestate-ai/business/business-model/` contains the tenant-specific version of that structure.
