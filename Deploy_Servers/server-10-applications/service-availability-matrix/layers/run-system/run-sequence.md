...
It exists so the platform moves through capability interpretation in an ordered way.
...
The run sequence should move through the capability chain in a deliberate order.
